...
{
    // TODO: Double check exactly what attach / detach and enable / disable should touch, also double check older test cases for correctness
    ...
    // TODO: getWaitingToBag() is never updated / used so check if it is needed
    @Test
